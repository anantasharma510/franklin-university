    ...
    <section className="w-full px-8 py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-base md:text-lg text-muted-foreground my-4 md:my-6">
          Become part of the world's most trusted student recruitment platform. 
          Connect with 50+ UK universities and help students achieve their dreams.
        </p>
        <button className={cn(
...
const squareData = [
  ...
  {
    id: 6,
    src: "https://images.unsplash.com/photo-1519302959554-a75be0afc82a?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
  },
  {
    id: 7,
  ...
  {
    id: 9,
    src: "https://images.unsplash.com/photo-1523240798131-2e0b2b2b2b2b?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
  },
  {
    id: 10,
    src: "https://images.unsplash.com/photo-1562774053-701939374585?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
